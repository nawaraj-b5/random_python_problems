...
print ("The length of first name is : ", length_of_first_name )
print("The length of last name is : ",length_of_last_name )
print("First name has more length : ",first_name_has_more_length )
print("Last name has more length : ",last_name_has_more_length )
print("First name and Last name have equal length : ",both_have_equal_length )